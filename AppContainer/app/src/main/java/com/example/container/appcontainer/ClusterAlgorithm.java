 ...
 *
 * Adaptado por Emilia Rosa van der Heide para que los clusters solo se creen
 * cuando los markers están a muy poca distancia
 *
 */
 ...
 */
public class ClusterAlgorithm<T extends ClusterItem> extends NonHierarchicalDistanceBasedAlgorithm<T> {
    public static final int MAX_DISTANCE_AT_ZOOM = 25; // essentially 25 dp. originalmente es 100 (google)
